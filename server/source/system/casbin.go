...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		{Ptype: "p", V0: "888", V1: "/campusProduct/updateCampusProductStatus", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/campusCategory/getCampusCategoryList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/campusCategory/findCampusCategory", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/campusCategory/createCampusCategory", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/campusCategory/updateCampusCategory", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/campusCategory/updateCampusCategoryStatus", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/campusUser/getCampusUserList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/campusUser/findCampusUser", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/campusUser/updateCampusUserStatus", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/campusAdminStaff/getCampusAdminStaffList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/campusAdminStaff/findCampusAdminStaff", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/campusAdminStaff/updateCampusAdminStaffStatus", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/campusAnnouncement/getCampusAnnouncementList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/campusAnnouncement/findCampusAnnouncement", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/campusAnnouncement/createCampusAnnouncement", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/campusAnnouncement/updateCampusAnnouncement", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/campusAnnouncement/deleteCampusAnnouncement", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/campusAnnouncement/updateCampusAnnouncementStatus", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/campusOrder/getCampusOrderList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/campusOrder/findCampusOrder", V2: "GET"},
		...
		{Ptype: "p", V0: "9528", V1: "/campusCategory/findCampusCategory", V2: "GET"},
		{Ptype: "p", V0: "9528", V1: "/campusUser/getCampusUserList", V2: "GET"},
		{Ptype: "p", V0: "9528", V1: "/campusUser/findCampusUser", V2: "GET"},
		{Ptype: "p", V0: "9528", V1: "/campusAdminStaff/getCampusAdminStaffList", V2: "GET"},
		{Ptype: "p", V0: "9528", V1: "/campusAdminStaff/findCampusAdminStaff", V2: "GET"},
		{Ptype: "p", V0: "9528", V1: "/campusAnnouncement/getCampusAnnouncementList", V2: "GET"},
		{Ptype: "p", V0: "9528", V1: "/campusAnnouncement/findCampusAnnouncement", V2: "GET"},
		{Ptype: "p", V0: "9528", V1: "/campusOrder/getCampusOrderList", V2: "GET"},
