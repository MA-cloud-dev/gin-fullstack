...
func (i *initApi) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysApi{
		...
		{ApiGroup: "分类管理", Method: "GET", Path: "/campusCategory/getCampusCategoryList", Description: "获取分类列表"},
		{ApiGroup: "分类管理", Method: "GET", Path: "/campusCategory/findCampusCategory", Description: "获取分类详情"},
		{ApiGroup: "分类管理", Method: "POST", Path: "/campusCategory/createCampusCategory", Description: "创建分类"},
		{ApiGroup: "分类管理", Method: "PUT", Path: "/campusCategory/updateCampusCategory", Description: "更新分类"},
		{ApiGroup: "分类管理", Method: "POST", Path: "/campusCategory/updateCampusCategoryStatus", Description: "更新分类状态"},
		{ApiGroup: "校园用户管理", Method: "GET", Path: "/campusUser/getCampusUserList", Description: "获取校园用户列表"},
		{ApiGroup: "校园用户管理", Method: "GET", Path: "/campusUser/findCampusUser", Description: "获取校园用户详情"},
		{ApiGroup: "校园用户管理", Method: "POST", Path: "/campusUser/updateCampusUserStatus", Description: "更新校园用户状态"},
		{ApiGroup: "B端管理", Method: "GET", Path: "/campusAdminStaff/getCampusAdminStaffList", Description: "获取B端管理员列表"},
		{ApiGroup: "B端管理", Method: "GET", Path: "/campusAdminStaff/findCampusAdminStaff", Description: "获取B端管理员详情"},
		{ApiGroup: "B端管理", Method: "POST", Path: "/campusAdminStaff/updateCampusAdminStaffStatus", Description: "更新B端管理员状态"},
		{ApiGroup: "公告管理", Method: "GET", Path: "/campusAnnouncement/getCampusAnnouncementList", Description: "获取公告列表"},
		{ApiGroup: "公告管理", Method: "GET", Path: "/campusAnnouncement/findCampusAnnouncement", Description: "获取公告详情"},
		{ApiGroup: "公告管理", Method: "POST", Path: "/campusAnnouncement/createCampusAnnouncement", Description: "创建公告"},
		{ApiGroup: "公告管理", Method: "PUT", Path: "/campusAnnouncement/updateCampusAnnouncement", Description: "更新公告"},
		{ApiGroup: "公告管理", Method: "DELETE", Path: "/campusAnnouncement/deleteCampusAnnouncement", Description: "删除公告"},
		{ApiGroup: "公告管理", Method: "POST", Path: "/campusAnnouncement/updateCampusAnnouncementStatus", Description: "更新公告状态"},
		{ApiGroup: "交易信息管理", Method: "GET", Path: "/campusOrder/getCampusOrderList", Description: "获取交易信息列表"},
		{ApiGroup: "交易信息管理", Method: "GET", Path: "/campusOrder/findCampusOrder", Description: "获取交易信息详情"},
